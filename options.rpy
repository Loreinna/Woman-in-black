...
define config.name = _("Девочка в черном")

## Показатель заголовка
## False, чтобы спрятать заголовок.
...
define gui.about = _p("""
Всем спасибо за прохождение игры!\n
Автор-Lorein.\n
Музыка:
Joep Beving - Ala
Betatrip – compassion
...
define build.name = "womaninblack"
...
define config.save_directory = "ffff-1679945870"
