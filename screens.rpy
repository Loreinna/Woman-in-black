...
screen main_menu():
    ...
    imagemap:
        ...
        #Начать игру
        hotspot(21, 105, 394, 163) action Start()
        #Загрузить
        hotspot(24, 276, 511, 139) action ShowMenu("load")
        #Настройки
        hotspot(23, 416, 526, 125) action ShowMenu("preferences")
        #Об игре
        hotspot(27, 545, 423, 121) action ShowMenu("about")
        #Помощь
        hotspot(26, 683, 316, 77) action ShowMenu("help")
        #Выход
        hotspot(9, 938, 434, 134) action Quit(confirm=True)
